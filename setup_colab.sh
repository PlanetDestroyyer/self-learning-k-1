...
echo ""
echo "Next steps:"
echo "  1. Quick test (5 min):  python3 test_modular_architecture.py"
echo "  2. Train K-1 (30 min):  python3 train_k1_dataset1.py"
echo "  3. Train baseline:      python3 train_baseline_all.py"
echo ""
